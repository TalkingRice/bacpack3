...
public class ApprovalActivity extends AppCompatActivity {
    ...
    public void getUnapprovedEvents() {
        String tag_string_req = "req_getUnapprovedEvents";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Config.URL_GET_UNAPPROVED_EVENT, new Response.Listener<String>() {
            @Override
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < length; i++) {
                        ...
                        events.put(approval, "0");
                        eventList.add(events);
                    }
                    mAdapter = new RecyclerViewAdapter(ApprovalActivity.this, eventList, user_id);
